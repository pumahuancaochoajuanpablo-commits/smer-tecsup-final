...
<head>
    ...
    <style>
        ...
        .header h1 { margin: 0; color: #366092; font-size: 28px; }
        .header p { margin: 5px 0; color: #666; }
        .section { margin-bottom: 30px; page-break-inside: avoid; }
        .section-title { background: #f0f0f0; padding: 10px; font-weight: bold; color: #366092; border-left: 4px solid #366092; margin-bottom: 15px; font-size: 16px; }
        .stats-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 15px; margin-bottom: 20px; }
        .stat-box { background: #366092; color: white; padding: 20px; border-radius: 8px; text-align: center; }
        .stat-box.alto { background: #dc3545; }
        .stat-box.medio { background: #ffc107; color: #222; }
        .stat-box.bajo { background: #28a745; }
...
<body>
    <div class="header">
        ...
        <p>Sistema de Gestion y Seguimiento de Entrevistas Estudiantiles (SMER)</p>
        <p>Reporte generado: {{ $fecha_generacion }}</p>
    </div>

    <div class="section">
        <div class="section-title">ESTADISTICAS GENERALES</div>
