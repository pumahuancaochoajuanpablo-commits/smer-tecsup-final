...
<body>
    <div class="header">
        ...
        <p>Sistema de Gestión y Seguimiento de Entrevistas (SMER)</p>
    </div>
    ...
    @if($asignacion)
    <div class="section">
        <div class="section-title">👨‍🏫 INFORMACIÓN DE TUTORÍA</div>
        <table>
            <tr>
    ...
    @else
    <div class="info-box">
        <strong>ℹ️ Información:</strong> Este estudiante no tiene entrevistas registradas aún.
    </div>
    @endif
