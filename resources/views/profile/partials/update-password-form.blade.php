<section>
    <header>
        <h2 class="text-lg font-medium text-gray-900">Cambiar contrasena</h2>
        <p class="mt-1 text-sm text-gray-600">Usa una contrasena segura y facil de recordar para ti.</p>
    </header>
